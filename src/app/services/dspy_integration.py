"""
DSPy integration service for optimized response generation
"""
import asyncio
import json
import logging
...
class DSPyIntegrationService:
    """Service for DSPy optimized response generation"""
    ...
    def __init__(self, settings: Settings, instructor_client: AsyncInstructor):
        ...
        logger.info("Initialized DSPy integration service")
    ...
    def _create_lm_client(self) -> dspy.LM:
        ...
        return dspy.LM(
            ...
            api_base=self.settings.llm.student_base_url,
            api_key=self.settings.llm.student_api_key,
            model_type="chat",
            cache=False,
            temperature=0.3,
            max_tokens=8192,
